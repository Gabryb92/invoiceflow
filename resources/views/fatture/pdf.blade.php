...
<head>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* TABELLA ITEMS - AGGIUNTE LARGHEZZE FISSE E WHITE-SPACE */
    .items-table th { 
        text-align: left; 
        padding: 8px 10px; 
    ...
    .items-table th:nth-child(2), .items-table td:nth-child(2) { width: 8%; }
    ...
    .items-table th:nth-child(5), .items-table td:nth-child(5) { width: 8%; }
    ...
    /* PREVIENI A CAPO PER COLONNE NUMERICHE */
